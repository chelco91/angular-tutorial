			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="navbar-header">
						<a class="navbar-brand" href="#"><img alt="Brand" src="./lib/images/brand.png" height="20"></a>
						<p class="navbar-text"><strong>Angular</strong> Projects & Tutorials</p>
					</div>
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav pull-right">
							<li role="presentation" class="active"><a href="#">Home</a></li>
							<li role="presentation"><a href="./projects/store.php">Project-1</a></li>
							<li role="presentation"><a href="./projects/project-2.php">Project-2</a></li>
							<li role="presentation"><a href="./projects/project-3.php">Project-3</a></li>
						</ul>
					</div>
				</div>
			</nav>
